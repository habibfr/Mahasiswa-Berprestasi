...
Route::controller(KriteriaController::class)->group(function () {
  Route::middleware('auth')->group(function () {
    ...
    Route::post('/subkriteria', 'subkriteria')
      ->name('subkriteria');

    // Route Update Kriteria
    Route::post('/upkriteria', 'edit')
      ->name('upkriteria');

    // Route Delete Kriteria
    Route::post('/deskriteria', 'destroy')
      ->name('deskriteria');

    // Route insert Kriteria
    Route::post('/insubkriteria', 'substore')
      ->name('insubkriteria');

    // Route Update SubKriteria
    Route::post('/upsubshow', 'subeditshow')
      ->name('upsubshow');

    // Route Update SubKriteria
    Route::post('/upsubkriteria', 'subedit')
      ->name('upsubkriteria');
